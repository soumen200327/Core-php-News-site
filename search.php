<?php include 'header.php'; ?>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                if (isset($_GET['search'])) {
                   $serch_trem = mysqli_real_escape_string($conn,$_GET['search']);
                }

                
                ?>
                <div class="post-container">
                  <h2 class="page-heading">search : <?php echo  $serch_trem; ?></h2>
                  <?php
                    ...
                    WHERE   post.status = 1 and post.title LIKE '%{$serch_trem}%' or  post.description LIKE '%{$serch_trem}%'
                                        ...
                                        <div class="inner-content clearfix">
                                            ...
                                            <div class="post-information">
                                                ...
                                                <span>
                                                    ...
                                                    <a href='author.php ? search=<?php echo $row['username']; ?>'><?php echo $row['username']; ?></a>
                                                </span>
                                                <span>
    ...
    $sql1 = "SELECT * FROM post WHERE post.title LIKE '%{ $serch_trem}%' or  post.description LIKE '%{$serch_trem}%';";
   ...
   if (mysqli_num_rows($result1) > 0) {
    ...
    if ($page > 1) {
        echo '<li><a href="post.php?search=' . ($page - 1) . '">Prev</a><li>';
    }
