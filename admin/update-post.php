    ...
    <div class="col-md-offset-3 col-md-6">
        ...
        <?php
               ...
               $ruselt = mysqli_query($conn, $sql)or die("Query failed.");
                ...
                ?>
        <form action="update-save_post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <option disabled> Select Category</option>
                              ...
                              $result1 = mysqli_query($conn, $sql1) or die("Quary faild.");
