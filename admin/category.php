                ...
                <table class="content-table" method="GET">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td class='edit'><a href='update-category.php ? rd=<?php echo $row['category_id']; ?> '><i class='fa fa-edit'></i></a></td>
                            <td class='delete'><a href='delete-category.php ? rd=<?php echo $row['category_id']; ?>'><i class='fa fa-trash-o'></i></a></td>
                        </tr>
                       <?php 
                            }
